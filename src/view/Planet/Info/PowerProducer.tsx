...
export default ({ powerPlanetLevel, fuelDemand, powerOutput, energyPrice }: {
    powerPlanetLevel: number,
    fuelDemand: number,
    powerOutput: number,
    energyPrice: number,
}) => {
    return <fieldset title="The producer panel shows details about power plants of this planet.">
