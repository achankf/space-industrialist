...
export default () => {
    return <Window >
        ...
        <ContentPanel>
            ...
            <p>Since you are the only player in the galaxy, the only way to earn money is to sell goods that are consumed by citizens [{BASIC_GOODS}, {LUXURY_GOODS}] and by power plants [{Product[Product.Fuel]}] -- other intermediate goods are merely transferred to your industry by your traders, e.g. when you trader sells a unit of Crop, your industry will buy it back, so no money is earned.</p>
