    ...
    return (
      <div id="menu">
        ...
        <div>
          ...
          <button title="Save game" onClick={this.save}>
            <i className="material-icons">save</i>
          </button>
          <button title="Slow down game speed" onClick={this.props.slowDown}>
            <i className="material-icons">fast_rewind</i>
          </button>
          <button onClick={this.pauseResumeGame} title={pauseTitle}>
            <i className="material-icons">{pauseText}</i>
          </button>
          <button title="Increase game speed" onClick={this.props.speedUp}>
            <i className="material-icons">fast_forward</i>
          </button>
          <button title="Open tutorial" onClick={this.props.createTutorial}>
...
const dispatchers = (
  dispatch: Dispatch<ClosableAction | ISpeedCommandAction>
): IMenuDispatchProps => ({
  createImportExport: () =>
    dispatch(addClosable(ClosablePanelType.ImportExport)),
